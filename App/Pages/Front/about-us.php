                    ...
                    <div class="row">
                        <div class="col-lg-10">
                            <div class="b-about__inner">
                                <h2 class="ui-title-block">About Flexy-Auto</h2>
                                ...
                                <div class="b-about-main">
                                    ...
                                    <p>Flexy-auto is aliquip exd ea consequat duis lorem ipsum dolor sit amet consectetur dipis icing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam quis nostrud exercitation.</p>
                                    ...
                                    <div class="b-about-main__btns">
                                        <a class="btn btn-dark" href="index.php?p=contact">Our partners</a>
                                        <a class="btn btn-primary" href="index.php?p=contact">learn more</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <ul class="b-about-list list-unstyled">
                                <li class="b-about-list__item"><i class="b-about-list__icon flaticon-travel"></i>
                                    <div class="b-about-list__inner">
                                        ...
                                        <div class="b-about-list__info">Flexy-auto is nisi aliquip ea consequat duis velit esse cillum dolore fugiat nulla pariatur excepteur sint occaecat.</div>
